...
def Tanaka2012GluA1Plasticity(beta,gamma, lo, x_sdx):
    """
    ...
    t_step2 = 4*60  # running for 50 secs
    factors.append(f2)
    g_factors.append(g2)
    ...
    t_steplast = 16*60  # running for 10 secs
    factors.append(finf)
...
Tanaka2012GluA1Plasticity(beta_array,gamma_arr, location, x_span_dx)
