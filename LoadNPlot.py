...
date_time = "08_24_2023_14_52_50"#"01_02_2023_13_13_25"#"12_25_2022_16_10_22"
per = "100"
labels = ["PC","PS","PSPINE"]
...
title = ax.text(0.5,0.95, "", bbox={'facecolor':'w', 'alpha':0.5, 'pad':5},
                transform=ax.transAxes, ha="center")
line, = ax.plot(x_grid_new,  data[labels[0]][index_min:index_max,0]/data[labels[0]][index_min:index_max,0], color = 'blue', lw=1,label=labels[0])
line2, = ax.plot(x_grid_new, data[labels[1]][index_min:index_max,0]/data[labels[1]][index_min:index_max,0], color = 'red', lw=1,label=labels[1])
line3, = ax.plot(x_grid_new, data[labels[2]][index_min:index_max,0]/data[labels[2]][index_min:index_max,0], color = 'green', lw=1,label=labels[2])
plt.legend(loc="upper right")
plt.ylim([0,7])
...
def comparePatterson(loc):
    ...
    total_surf = (data[labels[1]][loc,:] / data[labels[1]][loc,0]) + (data[labels[2]][loc, :]/data[labels[2]][loc, 0])
    plt.plot(tps,100*total_surf[0],color = "blue",label="model")
...
# comparePatterson([int(100/dx)])
# breakpoint()
compareTanaka([int(100/dx)])