...
def RunSimGluA2(delta_x,v_p,D_c,D_s,rat):
    ...
    fsize=16
    ax.plot(x,ps_dist,label=r"$p_s$",color = color_surf,linewidth=3.0)
    ax.plot(x,pc_dist,label=r"$P_c$",color = color_cyto,linewidth=3.0)
    ax.plot(x,ps_spine,label=r"$P_{spine}$",color = color_spine,linewidth=3.0)
...
# _ = widgets.interact(RunSimGluA2,v_p = (0,.01,0.001), Jcin = (0.001,0.1,0.005), alpha = (0.001,1,0.1),beta = (0.01,1,0.1),eta_s0 = (0, 0.1, .01),gamma=(1/43,0.1,0.01))
# RunSimGluA2(0.24,0.02,0.052,0.021)
# RunSimGluA2(0.24,4.06e-04,0.2,0.026144088,0.0043)
# RunSimGluA2(0.24,4.06e-03,3,0.26144088)
# RunSimGluA2(0.24, 9.2417e-04, 5.7359e-05 , 3.1866e-04,0.0043)
# RunSimGluA2(0.24,0.042,1.5,6.7)
# RunSimGluA2(0.24,0.003,.57,0.05)
# RunSimGluA2(0.24,0.02,.04,0.7)
# RunSimGluA2(0.24,0.016,.76,0.1)
# ps1,pc1 = RunSimGluA2(0.05,0.021,alpha=0.01,beta = 0.02,eta_s0=1/100,gamma=1/43)
# ps_dist,pc_dist = RunSimGluA2(0.02,1e-3,0.021)
# breakpoint()
# RunSimGluA2(1e-4,0.021,alpha=0.01,beta = 0.02,eta_s0=1/100,gamma=1/43)
# RunSimGluA2(0,0.021,alpha=0.01,beta = 0.02,eta_s0=1/100,gamma=1/43)
RunSimGluA2(0.24,1.1309585561316738e-05,0.10000081562301009 , 0.4230844182281098,0.45)
# RunSimGluA2(0.24, 2.0044e-05 ,0.14,0.09,0.00439753)
# RunSimGluA2(0.24, 0.03892047,6.0164127,0.01055499,0.00439753)